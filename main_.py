...
def seg_for_alllanguage(doc):
    ...
    if(space_number == words_doc-1 and space_number>0):
        ...
        if(os.path.exists('/data/zbh/bert_learn_token/learn_fenci/bert-master/word_dic.txt')):
            f1= open('/data/zbh/bert_learn_token/learn_fenci/bert-master/word_dic.txt','r',encoding='utf-8')
            for i in f1.readlines():
                word_list.append(i.strip('\n'))

        word_list = list(set(word_list))
        f1= open('/data/zbh/bert_learn_token/learn_fenci/bert-master/word_dic.txt','w',encoding='utf-8')
        for i in word_list:
            f1.write(str(i)+'\n')
...
if __name__ == '__main__':
    ...
    f1 = open(fl_ch,'r',encoding='utf-8')
